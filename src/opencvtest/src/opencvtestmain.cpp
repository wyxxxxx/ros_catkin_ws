...
int main(int argc, char** argv) {
	...
	Mat src = imread("/home/wyx/ros_catkin_ws/src/opencvtest/picturedata/manyobs1.jpg");
	...
	for (int row = 0; row < src.rows; row++) {
		for (int col = 0; col < src.cols; col++) {
			if ((src.at<Vec3b>(row, col)[0]>210)&&(src.at<Vec3b>(row, col)[1]>210)&&(src.at<Vec3b>(row, col)[2]>210)) {
